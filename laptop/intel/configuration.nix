...

{
  ...
  networking.hostName = "arcnix"; # Define your hostname.
  ...
  # Interface name of Ehternet is "enp61s0"
  # Interface name of WiFi is "wlo1"
  services.create_ap = {
    enable = true;
    settings = {
      INTERNET_IFACE = "enp61s0";
      WIFI_IFACE = "wlo1";
      SSID = "Intel Arc A730M";
      PASSPHRASE = "happyhacking";
    };
  };
  ...
  system.stateVersion = "25.3"; # Did you read the comment?
